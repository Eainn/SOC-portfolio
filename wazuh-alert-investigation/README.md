...
## 🔎 Log Analysis (Basic Threat Hunting)
...
![authenication failurer](.png)

**Insight:**
These manual queries helped validate and expand on the alerts generated by Wazuh, reinforcing evidence of brute-force and privilege escalation behavior.
